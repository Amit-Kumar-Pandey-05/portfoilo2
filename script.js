...
bootstrapbar = document.getElementById('bar4')
reactjsbar = document.getElementById('bar5')
...
window.addEventListener('scroll', () => {
  if (document.body.scrollTop > 1200 || document.documentElement.scrollTop > 1200) {
    ...
    bootstrapbar.classList.add('activebootstrap')
    reactjsbar.classList.add('activereactjs')

  }
})

const sw = document.querySelector('.switch')
swcircle = document.querySelector('.modeBtn')
